...
void parse_net_options_param(list *options, network *net, cfg_param grid_parameters)
{
    ...
    net->h = grid_parameters.height;
    net->w = grid_parameters.width;
...
network parse_network_cfg_param(char *filename, cfg_param grid_parameters)
{
    ...
    parse_net_options_param(options, &net, grid_parameters);
